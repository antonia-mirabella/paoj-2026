...
public class Main {
    public static void main(String[] args) {
        ...
        // 1. Adaugă 5 task-uri cu priorități diferite
        ...
        // 3. Schimbă status (inclusiv o tranziție invalidă în try-catch)
        System.out.println("\n=== Schimbări status ===");
        ...
        for (Status s : Status.values()) {
            System.out.println(s + ": " + service.getStatusSummary().get(s));
        }
